...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('pract', '0004_remove_goods_is_stock'),
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('product', models.ForeignKey(default=None, null=True, on_delete=django.db.models.deletion.SET_DEFAULT, to='pract.goods', verbose_name='Продукт')),
            ],
            options={
